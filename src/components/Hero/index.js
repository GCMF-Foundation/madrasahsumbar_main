...
function Hero(props) {
    return (
        <div className="col-12 hero-container">
            <div style={{ backgroundImage: `linear-gradient(171.31deg, rgba(0, 0, 0, 0.2) 81.78%, rgba(255, 255, 255, 0) 95.16%), url(${props.background})` }} className="hero-background hero-bg col-12"></div>
            <div style={{ backgroundImage: `linear-gradient(171.31deg, rgba(0, 0, 0, 0.2) 81.78%, rgba(255, 255, 255, 0) 95.16%), url(${props.backgroundMobile})` }} className="hero-background hero-bg-mobile col-12"></div>
